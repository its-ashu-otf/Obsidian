...
- Most of the WPSs in the routers usually lock when bruteforced for more than five times and can be unlocked only in
the administrator interface of the router manually