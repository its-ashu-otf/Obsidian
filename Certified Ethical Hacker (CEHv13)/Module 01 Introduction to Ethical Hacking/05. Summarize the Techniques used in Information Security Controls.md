...
<h1> RISK=Threat×Vulnerability×Impact </h1>


Alternatively, considering asset value:

RISK=Threat×Vulnerability×Asset Value\text{RISK} = \text{Threat} \times \text{Vulnerability} \times \text{Asset Value}
...
Level of Risk=Consequence×Likelihood\text{Level of Risk} = \text{Consequence} \times \text{Likelihood}
