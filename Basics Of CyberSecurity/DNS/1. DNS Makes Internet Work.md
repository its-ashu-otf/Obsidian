...
Operators who manage a DNS recursive resolver typically need to configure a _“root hints file”_. This file contains the names and IP addresses of the root servers, so the software can bootstrap the DNS resolution process. For many pieces of sof tware, this list comes built into the software.
