...
```
Your Browser ----> HTTP Request Packet (via TCP) ----> Web Server
Your Browser <---- HTTP Response Packet (via TCP) <---- Web Server
```

Meanwhile, DNS helped resolve the domain:

```
Your PC ----> DNS Request Packet ----> DNS Server
Your PC <---- DNS Response Packet <---- DNS Server
```
